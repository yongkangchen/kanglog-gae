<div id="wrapper">
	...
	<div id="header">
		...
		<div id="head-desc"><?=$Blog->desc?></div>
	</div><!-- end header -->
...
Copyright &copy; <?php echo date("Y") ?> <b><?=$Blog->name?></b>. <a href="feed.php">Entries (RSS)</a>. Clean Simple White Theme by <a href="http://mazznoer.web.id/">Mazznoer</a>. Powered by <a href="http://www.kanglog.com" target="_blank"><strong> kanglog 2.0    Author:小康</strong></a> 
<div id="footer-desc"><?=$Blog->desc?></div>
